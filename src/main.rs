...
use {{project-name | snake_case}}::{SettingsReader, APP_NAME, APP_VERSION, AppContext, start_grpc_server, {% if is_use_sb == "subscriber" or is_use_sb == "both" %}bind_sb_subscribers, {% endif %}};
...
async fn main() {
    ...
    start_grpc_server(app.clone(), {{grpc_port}});
